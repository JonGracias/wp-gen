...
function M.start(globals)
    ...
    local configure_apache = require("html.configure_apache")
    ...
    -- HERE CREATE THE PHPMYADMIN LINK OR SKIP IT IF SYMLINK WORKS CORRECTLY WILL HAVE TO CHECK IF FILE IS THERE, SYMLINK EXISTS, FINALLY IF SYMLINK POINTS TO THE CORRECT PLACE. 
end
return M